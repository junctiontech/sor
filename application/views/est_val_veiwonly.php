  						...
  						<table class="table table-bordered fill-head" >
							...
							<input type="hidden"  readonly name="edit_costing" id="edit_costing" value="1" />
  								<tr>
  									...
  									<td><input readonly type="text" required name="no[]" id="no_<?=$key+1?>" placeholder="No." class="form-control" value="<?=(!empty($sub->number))?$sub->number:"";?>">	
  									</td>
  									
  									<td><input readonly type="text" required name="length[]" id="length_<?=$key+1?>" placeholder="Length." class="form-control" value="<?=(!empty($sub->length))?$sub->length:"";?>">	
  									</td>
  									<td><input readonly type="text" required name="width[]" id="width_<?=$key+1?>" placeholder="Width." class="form-control" value="<?=(!empty($sub->width))?$sub->width:"";?>">	
  									</td>
  									<td><input readonly type="text" required name="depth[]" id="depth_<?=$key+1?>" placeholder="Depth." class="form-control" value="<?=(!empty($sub->heigth))?$sub->heigth:"";?>" onchange="calculate_quantity(this.id);total_quantity_onload('editTable')">	
  									</td>
  							...
  							<tbody id="dataTable"> 
  								...
  								<tr>
  										...
  										<td><input readonly type="checkbox" id="select_1"  
  										title="Check/Uncheck all" class="select_all" />
  										
  									</td>
  									<td><input readonly type="text" required name="no[]" placeholder="No." id="no_1" class="form-control">	
  									</td>
  									
  									<td><input readonly type="text" required name="length[]" placeholder="Length." id="length_1" class="form-control">	
  									</td>
  									
									<td><input readonly type="text" required name="width[]" placeholder="Width." id="width_1" class="form-control">	
  									</td>
  									
									<td><input readonly type="text" required name="depth[]" placeholder="Depth." id="depth_1" class="form-control"onchange="calculate_quantity(this.id);total_quantity_onload('dataTable')" >	
  									</td>
  									
									<td><input readonly  type="text" required readonly data-rule-required="true" class="input-mini-xs form-control required"  id="quantity_1" 
  										name="quantity[]" 	value="" >
  									</td>
