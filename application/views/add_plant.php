...
<div>
<h1><i class="fa fa-plus"></i> <?=(isset($plan_code))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[71]->text;}else{echo "Plant";}?> </h1>
</div>
</div>
<div id="breadcrumbs">
<ul class="breadcrumb">
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="box-title">
      	<h3><i class="fa fa-plus"></i> <?=(isset($plan_code))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[71]->text;}else{echo "Plant";}?> </h3>
       </div>
	 ...
	 <div class="row">
		 ...
		 <div class="">
			...
			<thead>
			<tr>
			<th style="width:20%"><?php if(isset($namehome)==1){echo $namehome[71]->text;}else{echo "Plant";}?></th>
