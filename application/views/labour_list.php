  ...
  <div class="col-md-12">
      ...
      <div class="box-content">
			...
			?>
			  ...
			  <td><a class="btn btn-primary btn-sm" href="<?=base_url()?>index.php/masters/manage_labour/<?=$li->labour_code?>"><i class="fa fa-edit"></i> Edit</a> <a class="btn btn-primary btn-sm" onClick="return confirm('Are you sure to delete this Labour? This will delete all the related records on this Labour as well.')" href="<?=base_url()?>index.php/masters/delete_material/0/<?=$li->labour_code?>"><i class="fa fa-edit"></i> DELETE</a></td>
		</tr>
