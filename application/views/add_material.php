...
<div>
<h1><i class="fa fa-plus"></i> <?=(isset($mat_name))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[53]->text;}else{echo "Material";}?></h1>
</div>
</div>
<div id="breadcrumbs">
<ul class="breadcrumb">
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="box-title">
      	<h3><i class="fa fa-plus"></i> <?=(isset($mat_name))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[53]->text;}else{echo "Material";}?></h3>
       </div>
	 ...
	 <div class="row">
		 ...
		 <div class="">
			...
			<thead>
			<tr>
			<th style="width:20%"><?php if(isset($namehome)==1){echo $namehome[26]->text;}else{echo "Code";}?></th>
			<th style="width:30%"><?php if(isset($namehome)==1){echo $namehome[10]->text;}else{echo "Description";}?></th>
			<th style="width:20%"><?php if(isset($namehome)==1){echo $namehome[25]->text;}else{echo "Class";}?></th>
			<th style="width:15%"><?php if(isset($namehome)==1){echo $namehome[34]->text;}else{echo "Unit";}?></th>
			<th style="width:10%"><?php if(isset($namehome)==1){echo $namehome[59]->text;}else{echo "Amount";}?></th>
			</tr>
			</thead>
			<tbody id="dataTable">
				<?php if(isset($mat_name)){?>
