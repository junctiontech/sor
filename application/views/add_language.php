...
<div>
<h1><i class="fa fa-plus"></i> <?=(isset($language_id))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[85]->text;}else{echo "Language";}?> </h1>
</div>
</div>
<div id="breadcrumbs">
<ul class="breadcrumb">
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="box-title">
      	<h3><i class="fa fa-plus"></i> <?=(isset($language_id))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[85]->text;}else{echo "Language";}?> </h3>
       </div>
      <div class="box-content">
      <form action="<?=base_url()?>index.php/home/add_language" method="post" class="form-horizontal form-row-separated" novalidate="novalidate" id="validation-form">
     <?php if(!isset($language_id)){?>
       ...
       <div class="row">
		 ...
		 <div class="">
			...
			<th style="width:45%"><?php if(isset($namehome)==1){echo $namehome[87]->text;}else{echo "Language Name";}?></th>
			...
			<td>  
				  <textarea name="language_name" id="unit_desc" rows="1" class="form-control" ><?=isset($language_name)?$language_name:''?></textarea>
			 </td>
		...
		<?php } else {?>
			...
			<td>  
				 <textarea name="language_name[]" id="language_name" rows="1" class="form-control"></textarea>
			</td>
