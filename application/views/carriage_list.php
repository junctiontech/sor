...
<div class="table-big">			 
			...
			?>
			  ...
			  <td><a class="btn btn-primary btn-sm" href="<?=base_url()?>index.php/home/manage_carriage/<?=$li->carriage_id?>"><i class="fa fa-edit"></i> Edit</a> <a class="btn btn-primary btn-sm" onClick="return confirm('Are you sure to delete this Carriage? This will delete all the related records on this Carriage as well.')" href="<?=base_url()?>index.php/home/delete_material/0/0/0/0/<?=$li->carriage_id?>"><i class="fa fa-edit"></i> DELETE</a>
			  <!--<a class="btn btn-primary btn-sm" href="<?=base_url()?>index.php/home/manage_carriage_cal/<?=$li->carriage_id?>"><i class="fa fa-edit"></i> Calculation</a></td>-->
		</tr>
