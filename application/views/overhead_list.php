...
<div class="table-big">			 
			...
			<table class="table table-hover fill-head table-advance" id="table1">
					  ...
					  <tr>
						  ...
						  <td><a class="btn btn-primary btn-sm" href="<?=base_url()?>index.php/masters/manage_overhead/<?=$ovl->overhead_name?>"><i class="fa fa-edit"></i> Edit</a> <a class="btn btn-primary btn-sm" onClick="return confirm('Are you sure to delete this Overhead? This will delete all the related records on this Overhead as well.')" href="<?=base_url()?>index.php/masters/delete_material/0/0/<?=$ovl->overhead_name?>"><i class="fa fa-edit"></i> DELETE</a>
