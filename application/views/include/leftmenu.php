...
<li><a href="<?=base_url()?>index.php/authority/user_role"> <i class="fa fa-user"></i><span>User Management</span></a></li>
<li><a href="<?=base_url()?>index.php/authority/role_management"> <i class="fa fa-users"></i><span>Role Management</span></a></li><!--
<li class="">
