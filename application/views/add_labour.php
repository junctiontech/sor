...
<div>
<h1><i class="fa fa-plus"></i> <?=(isset($labour_name))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[59]->text;}else{echo "Labour";}?></h1>
</div>
</div>
<div id="breadcrumbs">
<ul class="breadcrumb">
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="box-title">
      	<h3><i class="fa fa-plus"></i> <?=(isset($labour_name))?"Edit":"Add"?> <?php if(isset($namehome)==1){echo $namehome[59]->text;}else{echo "Labour";}?></h3>
       </div>
	 ...
	 <div class="row">
		 ...
		 <div class="">
			...
			<th style="width:20%"><?php if(isset($namehome)==1){echo $namehome[58]->text;}else{echo "Amount";}?></th>
			</tr>
			</thead>
			<tbody id="dataTable">
				<?php if(isset($labour_name)){?>
