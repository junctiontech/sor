...
<div>
<h1><i class="fa fa-plus"></i> <?=(isset($labour_code))?"Edit":"Add"?> Labour</h1>
</div>
</div>
<div id="breadcrumbs">
<ul class="breadcrumb">
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="box-title">
      	<h3><i class="fa fa-plus"></i> <?=(isset($labour_code))?"Edit":"Add"?> Labour</h3>
       </div>
      <div class="box-content">
      <form action="<?=base_url()?>index.php/home/add_labour" method="post" class="form-horizontal form-row-separated" novalidate="novalidate" id="validation-form">
	 ...
	 <div class="row">
		 ...
		 <div class="">
			...
			<tr>
				 <input type="hidden" name="id" id="id" value="<?=isset($labour_code)?$labour_code:''?>"/>
			<td>
