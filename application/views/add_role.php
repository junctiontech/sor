								    ...
								    <table class="table table-striped table-bordered "id="table1">
										...
										<tbody>
											...
											<?php foreach($list_function as $list){
												...
												<td>
													<input type="checkbox" id="<?=$list->function_id?>" value="<?php echo $list->function_id; ?>" name="function[]" /><?php echo $list->function_id; ?>
												</td>
												
												<td>
												 <div class="controls">
													 <label class="checkbox">
														<!--<input type="hidden" id="<?=$list->function_id?>_read" value="0" name="read[]" />-->
														<input type="checkbox" id="<?=$list->function_id?>_read" value="1" name="read[]" /> 
													 </label>
												 </div>
												</td>
												<td>
